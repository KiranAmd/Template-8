    ...
    <nav className="w-full  bg-white pt-[14px] pb-[14px] ">
      <div className=" max-w-screen-xl mx-auto flex items-center justify-between px-4 lg:px-0">
        <div className="hidden md:flex gap-8 ml-3 ">
          <Link href="/" className="text-[#6088f3] text-[14px] font-medium">
            Home
          </Link>
        ...
        <div className="hidden md:flex items-center gap-8 ml-auto mr-4 ">
         <Link href="/contact"> <span className="font-normal text-[#636270] text-[14px]">
          ...
          <span className="font-medium text-[#100e1a] text-[14px] ml-1">
            (808) 555-0111
          </span>
        </div>
        <button
      ...
      {isMenuOpen && (
        <div className="lg:hidden flex flex-col gap-4 mt-4 px-4  ">
          <Link href="/" className="text-[#4893e9] text-[14px] font-medium">
            Home
          </Link>
          <Link href="/cart" className="text-gray-400[14px] font-medium">
            Shop
          </Link>
          <Link href="/product" className="text-gray-400[14px] font-medium">
            Product
          </Link>
          <Link href="/faq" className="text-gray-400[14px] font-medium">
            Pages
          </Link>
          <Link href="/about" className="text-gray-400[14px] font-medium">
            About
          </Link>
        </div>
      )}
